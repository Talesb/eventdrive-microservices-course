...
import com.talesb.microservices.kafka.admin.config.exception.KafkaClientException;
...
public class KafkaAdminClient {
	...
	public void createTopics() {
		...
		try {
			...
			throw new KafkaClientException("Reached max number of retry fro creating kafka topics", t);
		}
		checkTopicsCreated();
